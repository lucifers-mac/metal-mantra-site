        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-4 flex gap-3">
              ...
              <a href="https://facebook.com/metalmantra" target="_blank" rel="noopener noreferrer" className="text-mantra-muted hover:text-mantra-red transition-colors" aria-label="Facebook">
              ...
              <a href="https://discord.gg/metalmantra" target="_blank" rel="noopener noreferrer" className="text-mantra-muted hover:text-mantra-red transition-colors" aria-label="Discord">
