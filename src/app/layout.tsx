...
export const metadata: Metadata = {
  title: {
    default: "Metal Mantra — Heavy Music News & Culture",
  ...
  openGraph: {
    ...
    locale: "en_US",
    images: [{ url: "/metal-mantra-banner.png", width: 1200, height: 630, alt: "Metal Mantra — Heavy Music News & Culture" }],
  },
  twitter: {
    card: "summary_large_image",
    site: "@MetalMantraNews",
    images: ["/metal-mantra-banner.png"],
  },
  robots: {
    index: true,
    follow: true,
