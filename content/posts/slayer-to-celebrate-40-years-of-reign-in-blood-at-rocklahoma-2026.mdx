...
Slayer performing in the context of a *Reign In Blood* anniversary raises the obvious question: are they playing it front to back? That format has worked for other legacy artists — [Death Angel is doing the same thing right now with *Act III*](/death-angel-act-iii-tour-2026/) — and it works especially well with *Reign In Blood* because the album functions as a complete statement. Running it in sequence wouldn’t be a gimmick. It would be the logical choice.
